...
module design_1
  ...
  design_1_bin2bcd_0_0 bin2bcd_0
       (.clk(clk_wiz_0_clk_out1),
        ...
        .data_in({kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd,kalkulator_0_send_lcd}),
        .done(bin2bcd_0_done),
        .start(kalkulator_0_start_bcd));
  design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(clk_wiz_0_clk_out1));
  design_1_kalkulator_0_1 kalkulator_0
